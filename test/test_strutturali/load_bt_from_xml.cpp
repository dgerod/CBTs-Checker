...
SCENARIO("Test of the first stage of the pipeline: read file"){
    ...
    WHEN("The XML file contains a bad formed action"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_no_ActionTemplate.xml"), 
    ...
    WHEN("The XML file contains actions with contrastant preconditions"){
        cbtc::conditioned_behavior_tree cbtree;            
         REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_contrastant_preconditions0.xml"), 
            "Input XML file bad format: action cannot have 'c' and 'not c' as pre-conditions");
    }

    WHEN("The XML file contains actions with contrastant preconditions"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_contrastant_preconditions1.xml"), 
            "Input XML file bad format: action cannot have 'c' and 'not c' as pre-conditions");
    }

    WHEN("The XML file contains actions with contrastant postconditions"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_contrastant_postconditions0.xml"), 
            "Input XML file bad format: action cannot have 'c' and 'not c' as post-conditions");
    }

    WHEN("The XML file contains actions with contrastant postconditions"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_contrastant_postconditions1.xml"), 
            "Input XML file bad format: action cannot have 'c' and 'not c' as post-conditions");
    }
    ...
    WHEN("The XML file contains a BT not starting with the root"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_no_root.xml"), 
    ...
    WHEN("The XML file contains a BT without the tag <BehaviorTree> following the tag <root>"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_no_BehaviorTree.xml"), 
    ...
    WHEN("The XML file contains a BT with a not recognized CFN"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_not_recognized_CFN.xml"), 
    ...
    WHEN("The XML file contains a BT in which the tag <Behavior Tree> is not closed"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_no_closed_BehaviorTree.xml"), 
    ...
    WHEN("The XML file contains a BT in which the tag <root> is not closed"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_THROWS_WITH(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/stage_1_no_closed_root.xml"), 
    ...
    WHEN("The XML file contains no errors"){
        cbtc::conditioned_behavior_tree cbtree;            
        REQUIRE_NOTHROW(cbtc::tree_loader::bt_from_yarp_xml(cbtree, "./test/test_strutturali/stage_1/inputs/complete_CBT.xml"));
